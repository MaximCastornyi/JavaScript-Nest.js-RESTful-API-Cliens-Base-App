...
let QuotesService = class QuotesService {
    ...
    async getQuote(id) {
        try {
            ...
            throw new common_1.HttpException('client-base Not Found', common_1.HttpStatus.NOT_FOUND);
        }
    }
    createQuote(quote) {
...
QuotesService = __decorate([
    common_1.Injectable(),
    __param(0, mongoose_2.InjectModel('client-base')),
    __metadata("design:paramtypes", [typeof (_a = typeof mongoose_1.Model !== "undefined" && mongoose_1.Model) === "function" ? _a : Object])
], QuotesService);
exports.QuotesService = QuotesService;
//# sourceMappingURL=client-base.service.js.map